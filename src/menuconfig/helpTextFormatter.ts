...
export function formatRedText(htmlString: any) {
...
export function formatLinkText(htmlString: any) {
...
export function formatBulletPoint(htmlString: any) {
  ...
  if (htmlString) {
    ...
    if (
      ...
      bulletPointMatches.forEach((bulletPoint: any) => {
...
export function formatEndBulletPoint(htmlString: any) {
...
export function formatNewLine(htmlString: any) {
  if (htmlString) {
...
export function formatHelpText(helpString: any) {
